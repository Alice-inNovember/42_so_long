...
/*   Updated: 2022/10/18 15:02:28 by junlee2          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	wall_image_init(t_data *data, int *x, int *y)
{
...
void	prop_image_init(t_data *data, int *x, int *y)
{
	void	*(*png2image)(void *, char *, int *, int *);
...
void	player_image_init(t_data *data, int *x, int *y)
{
	void	*(*png2image)(void *, char *, int *, int *);
...
void	mob_image_init(t_data *data, int *x, int *y)
{
	void	*(*png2image)(void *, char *, int *, int *);
	...
	data->prop.congrats = png2image(data->mlx, CONGRATS, x, y);
	data->prop.dontpanic = png2image(data->mlx, DONTPANIC, x, y);
}
